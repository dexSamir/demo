                ...
                return this.each(function () {
                        ...
                        var showMeanMenu = function() {
                                ...
                                jQuery(removeElements).addClass('mean-remove');
                                    ...
                                    jQuery('.mean-container').prepend('<div class="mean-bar"><a href ="~/admin/#nav" class="meanmenu-reveal" style="'+meanStyles+'">Show Navigation</a><nav class="mean-nav"></nav></div>');
                                            ...
                                            if(meanExpandableChildren){
                                                jQuery('.mean-nav ul ul').each(function() {
                                                        if(jQuery(this).children().length){
                                                                jQuery(this,'li:first').parent().append('<a class="mean-expand" href ="~/admin/#" style="font-size: '+ meanMenuCloseSize +'">'+ meanExpand +'</a>');
                                                        }
                                                });
...
$.magnificPopup.registerModule(AJAX_NS, {
  ...
  options: {
    settings: null,
    cursor: 'mfp-ajax-cur',
    tError: '<a href ="~/admin/%url%">The content</a> could not be loaded.'
  },
...
$.magnificPopup.registerModule('image', {
  ...
  options: {
    ...
    titleSrc: 'title',
    verticalFit: true,
    tError: '<a href ="~/admin/%url%">The image</a> could not be loaded.'
  },
